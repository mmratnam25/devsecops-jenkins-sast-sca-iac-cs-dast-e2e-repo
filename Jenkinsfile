pipeline {
  ...
  stages{
    stage('CompileandRunSonarAnalysis') {
            steps {	
		bat 'mvn clean verify sonar:sonar -Dsonar.organization=mmratnam -Dsonar.host.url=https://sonarcloud.io -Dsonar.token=41e1f2e5282b9ba08c8d51eabc4d7ddde2aebe86'
			}
    }
   }
}
